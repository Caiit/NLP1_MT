...
def evalutateData(src, target, predicted, attentions):
    ...
    with progressbar.ProgressBar(max_value=len(predicted)) as bar:
        for i in range(len(predicted)):
            ...
            translations.append((eng, dutch, pred))
            bar.update(i)
...
if __name__ == "__main__":
    eng, nld, predicted, attentions = readData("./data/eng_short.txt", "./data/nld_short.txt", "./output/old_data_predict_short.txt", "./output/attentions_short.pkl")
